...
class _TempMapScreenState extends State<TempMapScreen> {
  ...
  //       height: 30,
  //       width: 30,
  //       point: listParentAssetResponse.map((asset) => LatLng(asset.latitude ?? 0.0, asset.longitude ?? 0.0)),
          ...
          SizedBox(
            ...
            child: isAssetLoading == true
                ...
                : PopupScope(
                    ...
                    child: FlutterMap(
                      options: MapOptions(
                        initialCenter: listParentAssetResponse
                            .map(
        ...
        for (var asset in listParentAssetResponse) {
          markers.add(
            Marker(
              height: 40,
              width: 40,
              point: LatLng(asset.latitude ?? 0.0, asset.longitude ?? 0.0),
              child: const Icon(
                Icons.pin_drop,
                color: Colors.red,
                size: 40,
